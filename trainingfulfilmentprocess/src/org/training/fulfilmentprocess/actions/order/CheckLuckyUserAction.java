 ...
 * BusinessProcess.
 */
public class CheckLuckyUserAction extends AbstractSimpleDecisionAction<OrderProcessModel>
{
	private static final Logger LOG = Logger.getLogger(CheckLuckyUserAction.class);
	...
	public Transition executeAction(final OrderProcessModel process)
	{
		...
		if (getCheckOrderService().checkLuckyUser(order))
		{
