			...
			<tbody id="cart_items_tbody">
				<c:forEach items="${allItems}" var="entry">
					...
					<tr>
						...
						<td headers="header3"><format:price
								priceData="${entry.basePrice}" /></td>
						<td headers="header4" class="quantity">${entry.quantity}</td>
						<td headers="header5" class="shipping"></td>
						<td headers="header6" class="total"><format:price
