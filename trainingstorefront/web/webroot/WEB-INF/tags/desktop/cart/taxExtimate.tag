...
<%@ attribute name="showTaxEstimate" required="true"
...
<c:if test="${cartData.net && showTaxEstimate}">
	...
	<tr id="countryWrapperDiv">
		<td><spring:theme code="basket.page.totals.deliverycountry" /></td>
		<td id="estimatedCountry"><select id="countryIso">
	...
	<tr id="zipCodewrapperDiv">
		<td><spring:theme code="basket.page.totals.estimatedZip" /></td>
		<td>
	...
	<tr class="hidden estimatedTotals">
		<td><spring:theme code="basket.page.totals.estimatedtotaltax" />
		</td>
		<td id="estimatedTotalTax" class="hidden estimatedTotals"><format:price
				priceData="${cartData.totalTax}" /></td>
	</tr>

	<tr class="total hidden estimatedTotals">
		<td><spring:theme code="basket.page.totals.estimatedtotal" /></td>
