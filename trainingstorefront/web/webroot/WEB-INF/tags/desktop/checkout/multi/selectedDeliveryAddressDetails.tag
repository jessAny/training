...
<%@ attribute name="deliveryAddress" required="true"
...
<div class="existing_address">
	...
	<c:if test="${hasShippedItems}">
		...
		<ycommerce:testId code="selectedDeliveryAddressDetails_change_button">
			<a
				href="${changeDeliveryAddressUrl}/?editAddressCode=${deliveryAddress.id}"
				class="right"><spring:theme
