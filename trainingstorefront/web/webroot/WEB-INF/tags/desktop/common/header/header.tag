...
<c:if
	...
	<div class="backToMobileStore">
		<a href="${clearUiExperienceLevelOverrideUrl}"><span
			class="greyDot">&lt;</span>
		<spring:theme code="text.swithToMobileStore" /></a> <span
			class="greyDot closeDot"><a href="${stayOnDesktopStoreUrl}">x</a></span>
	</div>
</c:if>
...
<div id="header" class="clearfix">
	...
	<div class="headerContent ">
		<ul class="nav clearfix">
				...
				<c:if test="${uiExperienceOverride}">
					<li class="backToMobileLink"><c:url
						...
						href="${backToMobileStoreUrl}"><spring:theme
								code="text.backToMobileStore" /></a></li>
				</c:if>
			...
			<c:if test="${empty hideHeaderLinks}">
				<li><a href="<c:url value="/store-finder"/>"><spring:theme
