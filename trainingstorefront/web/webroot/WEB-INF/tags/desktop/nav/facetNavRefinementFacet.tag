			...
			<div class="facetValues">
				<c:if test="${not empty facetData.topValues}">
					<div class="topFacetValues">
								...
								<li><c:if test="${facetData.multiSelect}">
										<form action="#" method="get">
											<input type="hidden" name="q"
												value="${fn:escapeXml(facetValue.query.query.value)}" /> <input
												type="hidden" name="text"
												value="${fn:escapeXml(searchPageData.freeTextSearch)}" /> <label
						...
						<span class="more"> <a href="#" class="moreFacetValues"><spring:theme
