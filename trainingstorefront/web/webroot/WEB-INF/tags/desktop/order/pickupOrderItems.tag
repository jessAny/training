...
<div class="pickup_item_container_holder"
	id="pickup_item_container_holder_${index}">
	<div class="item_container">
		<table class="your_cart">
			<thead>
				<tr>
					<th id="header_2" colspan="2"><span class="hidden"><spring:theme
								code="basket.page.title" /></span></th>
			...
			<tbody id="cart_items_tbody">
				<c:forEach items="${groupData.entries}" var="entry">
					...
					<tr>
						<td headers="header_2" class="product_image"><span
						...
						<td headers="header_3" class="quantity">${entry.quantity}</td>
						<td headers="header_4" class="itemPrice"><format:price
								priceData="${entry.basePrice}" displayFreeForZero="true" /></td>
						<td headers="header_5" class="total"><format:price
