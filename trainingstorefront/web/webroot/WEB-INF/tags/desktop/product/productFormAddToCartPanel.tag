...
<div class="orderForm clearfix">
	<div class="headline">
		<spring:theme code="order.form.total" />
	</div>
	<div class="clearfix">
		<div class="left total-items-count">
			(<span id="total-items-count">0</span>
			<spring:theme code="product.grid.itemsText" />
			)
		</div>
	...
	<div class="left viewDetailButton">
		<c:if test="${showViewDetails != false}">
			...
			<a href="${backToProductUrl}" class="button"><spring:theme
	...
	<div id="orderFormAddToCart" class="right prod_add_to_cart">
		...
		<button id="addToCartBtn" type="button" class="positive"
			disabled="disabled">
			<spring:theme code="text.addToCart" var="addToCartText" />
