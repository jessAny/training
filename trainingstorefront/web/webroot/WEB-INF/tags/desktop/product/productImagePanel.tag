...
<div class="span-14 productImage">
	<div class="productImageGallery">
		<ul class="jcarousel-skin">
			<c:forEach items="${galleryImages}" var="container"
				varStatus="varStatus">
				<li><span class="thumb ${(varStatus.index==0)? "active":""}">
	...
	<div class="productImagePrimary" id="primary_image">
		...
		<a class="productImagePrimaryLink" id="imageLink"
			href="${productZoomImagesUrl}" data-href="${productZoomImagesUrl}"
			target="_blank" title="<spring:theme code="general.zoom"/>"> <product:productPrimaryImage
				product="${product}" format="zoom" />
		</a>
		<ycommerce:testId code="productDetails_zoomImage_button">
			<a class="productImageZoomLink" id="zoomLink"
				href="${productZoomImagesUrl}" data-href="${productZoomImagesUrl}"
				target="_blank" title="<spring:theme code="general.zoom"/>"> </a>
		</ycommerce:testId>
	</div>
</div>