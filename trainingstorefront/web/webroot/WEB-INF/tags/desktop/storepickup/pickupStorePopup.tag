...
<div id="popup_store_pickup_form" class="searchPOS clearfix"
	style="display: none">
	...
	<div class="column last searchPOSContent">
		<form:form name="pickupInStoreForm" action="${actionUrl}"
			method="post" class="searchPOSForm clearfix">
			<table>
				<tr>
					<td>
						<div class="control-group left">
							<div class="controls">
								<input type="text" name="locationQuery"
									data-id="locationForSearch" class="left"
									placeholder="<spring:theme code="pickup.search.message" />" />
							</div>
						</div> <input type="hidden" name="cartPage" data-id="atCartPage"
						value="${cartPage}" /> <input type="hidden" name="entryNumber"
						value="${entryNumber}" class="entryNumber" />
					</td>
					<td><button type="submit" class=""
