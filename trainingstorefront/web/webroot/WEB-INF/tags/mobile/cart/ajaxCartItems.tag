			...
			<thead>
				<tr>
					<th id="header1"><span class="hidden"><spring:theme
								code="basket.page.product" /></span></th>
					<th id="header2"><span class="hidden"><spring:theme
								code="basket.page.productdetails" /></span></th>
			...
			<tbody id="cart_items_tbody">
				<c:forEach items="${allItems}" var="entry">
					...
					<tr>
						...
						<td headers="header3" class="quantity">${entry.quantity}</td>
						<td headers="header4"><format:price
								priceData="${entry.basePrice}" /></td>
						<td headers="header5" class="total"><format:price
