	...
	<div class="expressCheckoutCheckbox clearfix right ui-grid-a">
		<div class="ui-block-a">
			<label for="expressCheckoutCheckbox"> <input
				...
				type="checkbox"
				data-express-checkout-url="<c:url value='/checkout/multi/express'/>"
				class="doExpressCheckout" /> <spring:theme
	...
	<div class="hidden">
		<div class="item_container_holder" id="checkoutInfo">
			<div class="expressCheckoutHelpContainer">
				<p>
					<spring:theme text="" code="text.expresscheckout.title" />
				</p>
				<ul type="square">
				...
				<p>
					<spring:theme code="text.expresscheckout.info1" />
				</p>
				<p>
					<spring:theme code="text.expresscheckout.info2" />
				</p>
				<p>
					<spring:theme code="text.expresscheckout.info3" />
				</p>
			</div>
		</div>
	</div>
