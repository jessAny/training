...
<li class='cartLi'><ycommerce:testId code="cart_product_name">
	...
	<div class="ui-grid-a cartItemproductImage">
		...
		<div class="ui-block-b">
			...
			<div class="ui-grid-a">
				...
				:&nbsp;<span class="priceItemHolder"><format:price
						priceData="${entry.basePrice}" displayFreeForZero="true" /></span>
			</div>
			<div class="ui-grid-a">
				<spring:theme code="basket.page.total" />
				:&nbsp;<span class="priceItemHolder"><format:price
						priceData="${entry.totalPrice}" displayFreeForZero="true" /></span>
			</div>
		</div>
	</div>
	<div class="ui-grid-a">
		<c:if
			test="${not empty cartData.potentialProductPromotions && showPotentialPromotions}">
