...
<div data-theme="b" data-role="content">
	<h6 class="descriptionHeadline">
		<spring:theme code="text.headline.orderinfo"
			text="All information about delivery address, delivery method and payment method" />
	</h6>
	<div class="checkout_summary_flow_c ${paymentInfoOk ? 'complete' : ''}"
							...
							<li>
								<div class="ui-grid-a" data-theme="b">
									<div class="ui-block-a" style="width: 60%">
										<spring:theme
											code="checkout.summary.paymentMethod.securityCode" />
										<a href="#" id="cvv2Description"
											data-cvv2description="<spring:theme code='checkout.summary.paymentMethod.securityCode.whatIsThis.description'/>">
											<br /> <spring:theme
												code="checkout.summary.paymentMethod.securityCode.whatIsThis" />
										</a>
									</div>
									<div class="ui-block-b" style="width: 40%">
										<input type="text" class="text security" id="SecurityCode"
											maxlength="5" style="width: 50px;" /><br />
									</div>
								</div>
							</li>
						</c:if>
					...
					<ycommerce:testId code="checkout_changePayment_element">
						<c:if test="${paymentInfoOk}">
							...
							<a href="${addPaymentMethodUrl}"
								class="edit_complete change_payment_method_button"
								data-theme="c"> <spring:theme
									code="mobile.checkout.edit.link" />
							</a>
						</c:if>
					</ycommerce:testId>
				</div>
