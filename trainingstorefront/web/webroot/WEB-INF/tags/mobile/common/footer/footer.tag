...
<h6 class="descriptionHeadline">
	<spring:theme code="text.headline.footer.navigationbar"
		text="Browse through the footer navigation bar" />
</h6>
<div id="footer" data-role="footer" data-theme="d"
	...
	<div class="switch-storefront" data-role="navbar">
		<ul>
			<li><a href="<c:url value="/_s/ui-experience?level=Desktop"/>">
	...
	<div id="copyright" class="switch-storefront copyright">
		<p>
			<spring:theme code="text.copyright" />
		</p>
	</div>
</div>
