...
<template:mobilePage pageId="facetRefinements-page"
	dataSearchQuery="${pageData.currentQuery.query.value}">
	<jsp:attribute name="header">
		<h3 data-role="heading">
			<spring:theme code="search.nav.refinements" />
		</h3>
		<a href="#" data-role="button" id="applyFilter" data-icon="check"
			data-theme="c" class="ui-btn-right"><spring:theme
