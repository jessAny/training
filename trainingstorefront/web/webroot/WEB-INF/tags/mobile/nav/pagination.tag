...
<div class="pagination">
	<div class="ui-grid-a">
		<div class="ui-block-a">
			<nav:paginationPageCounter searchPageData="${searchPageData}"
				msgKey="${msgKey}" />
		</div>
			...
			<div data-role="controlgroup" data-type="horizontal">
				...
				<c:if test="${hasPreviousPage}">
					...
					<ycommerce:testId code="searchResults_previousPage_link">
						<a href="${previousPageUrl}" data-role="button"> <spring:theme
				...
				<c:if test="${hasNextPage}">
					...
					<ycommerce:testId code="searchResults_nextPage_link">
						<a href="${nextPageUrl}" data-role="button"> <spring:theme
