...
<c:if
	test="${storeSearchPageData ne null and not empty storeSearchPageData.results}">
	<ul data-role="listview" data-split-theme="b" data-content-theme="c">
			...
			<div class="ui-grid-a">
				<div class="ui-block-a" style="width: 100%">
					<h3>
						...
						<span class="resultsItems"> (<spring:theme
								code="text.storefinder.mobile.page.totalResults"
								arguments="${storeSearchPageData.pagination.totalNumberOfResults}" />)
						</span>
					</h3>
				</div>
			</div>
		...
		<li>
			<div class="ui-grid-a">
				<nav:paginationPageCounter searchPageData="${storeSearchPageData}"
			...
			<li>
				<div class="ui-grid-b">
					...
					<div class="ui-block-b" style="width: 70%">
						<a href="${posUrl}" data-transition="slide"><span
							class="storeName">${pos.name}</span></a>
					</div>
				...
				<div class="ui-grid-a">
					...
					<div class="ui-block-b">
						<span class="stores-tel"><a
							href="tel:${ycommerce:encodeUrl(pos.address.phone)}">${pos.address.phone}</a></span>
					</div>
				</div>
			</li>
		</c:forEach>
	...
	<nav:pagination searchPageData="${storeSearchPageData}"
		searchUrl="${searchUrl}" msgKey="text.storefinder.mobile.page" />
</c:if>
