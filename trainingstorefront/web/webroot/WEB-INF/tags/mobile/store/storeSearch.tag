...
<%@ attribute name="isStoreDetailsPage" required="false"
...
<div class="item_container_holder">
	...
	<div class="storeSearch" data-theme="c">
		...
		<div data-role="fieldcontain" class="accmob-storeSearch">
				...
				<ycommerce:testId code="storeFinder_search_box">
					<div class="accmob-storeFinderFieldHolder">
						<label for="storelocator-query" class="skip"><spring:theme
							...
							id="storelocator-query" name="q" class="storeSearchBox"
							type="search"
			...
			<c:url value="/store-finder/position"
				var="nearMeStorefinderFormAction" />
			<form:form id="nearMeStorefinderForm" name="near_me_storefinder_form"
				method="POST" action="${nearMeStorefinderFormAction}">
				<input type="hidden" id="latitude" name="latitude" />
				<input type="hidden" id="longitude" name="longitude" />
				<a href="#" id="findStoresNearMe" class="form search" data-theme="d"
