...
<%@ attribute name="pageScriptsBeforeJspBody" required="false"
	fragment="true"%>
<%@ attribute name="pageScriptsAfterJspBody" required="false"
	fragment="true"%>
...
<%@ taglib prefix="addonScripts"
	tagdir="/WEB-INF/tags/mobile/common/header"%>
...
<body
	class="language-${currentLanguage.isocode} - ${pageBodyCssClasses} - ${cmsPageRequestContextData.liveEdit ? ' yCmsLiveEdit' : ''}">
