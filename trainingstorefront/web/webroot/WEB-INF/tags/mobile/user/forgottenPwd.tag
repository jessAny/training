...
<div data-role="content" data-content-theme="c" data-theme="c"
	id="forgottenPwd" class="forgottenPwd">
	<div class="accmob-navigationHolder">
		<div class="accmob-navigationContent">
			<div id="breadcrumb"
				class="accmobBackLink accmobBackLinkSingle registerNewCustomerLinkHolderBack">
				<a href="javascript:void(0)" data-role="link"
					class="productLink ui-link"> <spring:theme
						code="register.back.login" /> &raquo;
				</a>
			</div>
		</div>
	</div>
		...
		<div class="item_container">
			...
			<form:form method="post" commandName="forgottenPwdForm">
				...
				<ul class="mFormList" data-split-theme="d" data-theme="d">
					<li><formElement:formInputBox idKey="forgottenPwd.email"
							labelKey="forgottenPwd.email" path="email" inputCSS="text"
							mandatory="true" /></li>
					<li><ycommerce:testId code="forgottenPassword_sendEmail">
