...
<div class="loginTag" data-theme="e" data-content-theme="c">
	...
	<ul class="mContentList">
		<li class="continuous-text"><spring:theme
				code="login.description" /></li>
		<li class="continuous-text"><spring:theme
				code="login.required.message" /></li>
	</ul>
	<form:form action="${action}" method="post" commandName="loginForm"
		...
		<ul class="mFormList" data-theme="a" data-content-theme="a">
			<li><formElement:formInputBox idKey="j_username"
					labelKey="login.email" path="j_username" inputCSS="text"
					mandatory="true" /></li>
			<li><formElement:formPasswordBox idKey="j_password"
			...
			<li>
				<h6 class="descriptionHeadline">
					...
					<button type="submit" class="form" data-role="button"
						data-theme="b">
