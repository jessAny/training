...
<ul class="checkout-order-summary-list">
	<c:if test="${showHead}">
		<li class="checkout-order-summary-list-heading">
			<div class="title">
				<spring:theme code="checkout.multi.items.to.pickup" text="Pick up:" />
			</div>
			<div class="address">
				${groupData.deliveryPointOfService.name} <br>
				<c:if
	...
	<c:forEach items="${groupData.entries}" var="entry">
		...
		<li>
			...
			</div> <!--  <div class="stock-status">PickUpInStore Availability
				Notification</div> -->
