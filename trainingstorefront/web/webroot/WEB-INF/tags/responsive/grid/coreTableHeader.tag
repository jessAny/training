...
<c:if test="${readOnly != true}">
	<div class="update-future-stock hidden-xs">
		...
		<a href="#" class="update_future_stock_button positive"
			data-skus-id="${skusId}"
			data-skus-future-stock-url="${skusFutureStockUrl}"> <spring:theme
				code="product.grid.futurestock.updatefuture.availability" />
		</a> <a href="#" class="hide_future_stock_info positive"> <spring:theme
