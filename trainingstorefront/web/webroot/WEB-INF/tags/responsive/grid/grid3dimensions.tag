...
<c:forEach items="${product.variantMatrix}" var="firstVariant"
	...
	<c:if
		...
		<div class="orderForm_grid_group">
			...
			<grid:coreTableHeader variant="${firstVariant}" product="${product}"
