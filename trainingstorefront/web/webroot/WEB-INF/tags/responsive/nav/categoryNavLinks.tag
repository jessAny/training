...
<div class="nav_column product-facet js-product-facet"
	id="product-facet">
			...
			<div class="facet-values js-facet-values js-facet-form">
				<ul class="facet-list js-facet-list">
					<c:forEach items="${categories}" var="category">
						<li><c:url value="${category.url}" var="categoryUrl" /> <span
							class="facet-text"> <a href="${categoryUrl}">${category.name}</a>&nbsp;
