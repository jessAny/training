	...
	<ycommerce:testId code="facetNav_title_${facetData.name}">
		<div class="facet js-facet">
			...
			<div class="facet-values js-facet-values js-facet-form">
									...
									<form action="#" method="get">
										<input type="hidden" name="q"
											...
											class="facet-checkbox" /> <span class="facet-label">
												<span class="facet-mark"></span> <span class="facet-text">
													${facetValue.name} <ycommerce:testId code="facetNav_count">
				...
				<ul
					class="facet-list js-facet-list <c:if test="${not empty facetData.topValues}">facet-list-hidden js-facet-list-hidden</c:if>">
					<c:forEach items="${facetData.values}" var="facetValue">
						<li><c:if test="${facetData.multiSelect}">
								<ycommerce:testId code="facetNav_selectForm">
									<form action="#" method="get">
										<input type="hidden" name="q"
											...
											type="checkbox"
											${facetValue.selected ? 'checked="checked"' : ''}
											class="facet-checkbox js-facet-checkbox sr-only" /> <span
								...
								<c:url value="${facetValue.query.url}" var="facetValueQueryUrl" />
								<span class="facet-text"> <a href="${facetValueQueryUrl}">${facetValue.name}</a>
									<ycommerce:testId code="facetNav_count">
										<span class="facet-value-count"><spring:theme
												code="search.nav.facetValueCount"
												arguments="${facetValue.count}" /></span>
				...
				<c:if test="${not empty facetData.topValues}">
					<span class="more js-more-facet-values"> <a href="#"
						class="js-more-facet-values-link"><spring:theme
								code="search.nav.facetShowMore_${facetData.code}" /></a>
					</span>
					<span class="less js-less-facet-values"> <a href="#"
						class="js-less-facet-values-link"><spring:theme
