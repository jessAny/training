...
<div
	class="col-sm-6 col-sm-offset-6 col-md-5 col-md-offset-7 col-lg-4 col-lg-offset-8">
	...
	<div class="account-orderdetail-orderTotalDiscount-section">
		<c:if test="${not order.net}">
			<div class="order-total-taxes">
				<ycommerce:testId code="orderTotal_includesTax_label">
					<spring:theme code="text.account.order.total.includesTax"
						argumentSeparator=";" arguments="${order.totalTax.formattedValue}" />
				</ycommerce:testId>
			</div>
			<br />
		</c:if>
		<ycommerce:testId code="order_totalDiscount_label">
			<div class="order-savings">
				<spring:theme code="text.account.order.totalSavings"
					argumentSeparator=";"
