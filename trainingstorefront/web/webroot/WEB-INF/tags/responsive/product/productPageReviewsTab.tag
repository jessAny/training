...
<div class="tab-review">
	<div class="review-pagination-bar">
		...
		<div class="right">
			<button class="btn btn-default all-reviews-btn">
				<spring:theme code="review.show.all" />
			</button>
			<button class="btn btn-default less-reviews-btn">
				<spring:theme code="review.show.less" />
			</button>
		</div>
	</div>
		...
		<form:form method="post" action="${productReviewActionUrl}"
			...
			<div class="form-group">
				<formElement:formTextArea idKey="review.comment"
					labelKey="review.comment" path="comment" areaCSS="form-control"
					mandatory="true" />
			</div>
			...
			<div class="form-group">
				...
				<div class="rating rating-set js-ratingCalcSet"
					...
					<div class="rating-stars">
						<span
							class="js-ratingIcon js-rationIconSet glyphicon glyphicon-star"></span>
					</div>
				</div>

				<formElement:formInputBox idKey="review.rating"
					labelKey="review.rating" path="rating"
					inputCSS="sr-only js-ratingSetInput" labelCSS="sr-only"
					mandatory="true" />
	...
	<ul id="reviews" class="review-list"
		data-reviews="${getPageOfReviewsUrl}"
		data-allreviews="${getAllReviewsUrl}"></ul>
