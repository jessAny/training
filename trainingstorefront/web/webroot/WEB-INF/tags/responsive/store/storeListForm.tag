...
<div class="store-finder js-store-finder row"
	data-url="${storeFinderFormAction}">
	<ycommerce:testId code="storeFinder">
		<div class="col-lg-8">

			<div class="store-finder-pagination">
				<div class="pull-right">
					<button class="btn btn-default js-store-finder-pager-prev"
						type="button">
						<spring:theme code="storeFinder.pagination.previous"
							text="Previous"></spring:theme>
					</button>
					<button class="btn btn-default js-store-finder-pager-next"
						type="button">
						<spring:theme code="storeFinder.pagination.next" text="Next"></spring:theme>
					</button>
				</div>
				<span class="js-store-finder-pager-item-from"></span>- <span
					class="js-store-finder-pager-item-to"></span>
				<spring:theme code="storeFinder.pagination.from" text="from"></spring:theme>
				<span class="js-store-finder-pager-item-all"></span>
				<spring:theme code="storeFinder.pagination.stores"
					text="stores found"></spring:theme>
			</div>

			<div class="row store-finder-panel">
				<div class="store-finder-navigation">
					<ul
						class="store-finder-navigation-list js-store-finder-navigation-list">
				...
				<div class="store-finder-details js-store-finder-details">
					<div>
						<button
							class="btn btn-default store-finder-details-back js-store-finder-details-back">
