			...
			<div class="row">
						...
						<ycommerce:testId code="storeFinder_search_box">
							<div class="input-group">
								<formElement:formInputBox idKey="storelocator-query"
									labelKey="storelocator.query" path="q" labelCSS="sr-only"
									inputCSS="form-control js-store-finder-search-input"
									mandatory="true" placeholder="pickup.search.message" />
								<span class="input-group-btn">
									<button class="btn btn-primary" type="submit"
										data-search-empty="<spring:theme code="storelocator.error.no.results.subtitle" text="Check that you entered a valid postcode or place name."/>">
				...
				<div class="col-sm-6">
					<ycommerce:testId code="storeFinder_nearMe_button">
						<button id="findStoresNearMe" class="btn btn-primary btn-block"
