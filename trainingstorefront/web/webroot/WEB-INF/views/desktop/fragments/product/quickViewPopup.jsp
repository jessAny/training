...
<div id="quickviewLightbox" class="productDetailsPanel clearfix">
	<div class="column productImage">
		<div class="productImagePrimary">
			<a class="productImagePrimaryLink" href="${productUrl}"> <product:productPrimaryImage
	...
	<div class="column productDescription last">
		...
		<div class="prodReview clearfix">
			...
			<c:if test="${not empty product.reviews}">
				<c:url value="${product.url}#tab-reviews"
					var="productReadReviewsUrl" />
				<a class="count" href="${productReadReviewsUrl}"><spring:theme
						code="review.based.on" arguments="${fn:length(product.reviews)}" /></a>
			</c:if>

			<c:url value="${product.url}#tab-reviews"
				var="productWriteReviewsUrl" />
			<a class="write" href="${productWriteReviewsUrl}"><spring:theme
