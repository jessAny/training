...
<div class="span-24">
	<div class="span-20 last">
		<div class="accountContentPane clearfix">
			<div class="headline">
				<spring:theme code="text.account.change.email.address"
					text="Profile" />
			</div>
			...
			<div class="description">
				<spring:theme code="text.account.profile.updateEmailAddress"
					text="Enter your new email address and confirm with your password" />
			</div>

			<form:form action="update-email" method="post"
				commandName="updateEmailForm">
