		...
		<div id="checkoutContentPanel" class="clearfix">
			...
			<form:form method="post" commandName="paymentDetailsForm"
				...
				<div class="cardForm">
					...
					<formElement:formSelectBox idKey="cardType"
					...
					<fieldset id="startDate" class="cardDate">
						...
						<formElement:formSelectBox idKey="StartMonth"
							...
							skipBlank="false" skipBlankMessageKey="" items="${months}"
							tabindex="4" />
						<formElement:formSelectBox idKey="StartYear"
							labelKey="payment.year" path="startYear" mandatory="true"
							skipBlank="false" skipBlankMessageKey="" items="${startYears}"
							tabindex="5" />
					</fieldset>
					<fieldset class="cardDate">
						...
						<formElement:formSelectBox idKey="ExpiryYear"
							...
							skipBlank="false" skipBlankMessageKey="" items="${expiryYears}"
							tabindex="7" />
					</fieldset>
					<div id="issueNum">
				...
				<div id="newBillingAddressFields" class="cardForm">
					...
					<formElement:formInputBox idKey="address.postcode"
						...
						inputCSS="text" mandatory="true" tabindex="17" />
					<formElement:formSelectBox idKey="address.country"
						...
						items="${billingCountries}" itemValue="isocode" tabindex="18" />
				...
				<div class="form-actions">
					<c:if test="${not hasNoPaymentInfo}">
						<a class="button" href="${choosePaymentMethodUrl}"><spring:theme
								code="checkout.multi.cancel" text="Cancel" /></a>
					</c:if>
					<ycommerce:testId code="editPaymentMethod_savePaymentMethod_button">
						<button class="positive" tabindex="20" id="lastInTheForm"
							type="submit">
							<spring:theme
