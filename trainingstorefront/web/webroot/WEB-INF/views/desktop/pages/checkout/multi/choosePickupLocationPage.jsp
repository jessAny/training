...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
	...
	<div class="span-14 append-1">
		<multi-checkout:pickupConsolidationOptions cartData="${cartData}"
			pickupConsolidationOptions="${pickupConsolidationOptions}" />
		<multi-checkout:pickupGroups cartData="${cartData}" />

		<form:form id="selectDeliverylocationForm" action="${nextStep}"
			method="get">
			<button id="chooseDeliveryLocation_continue_button"
				class="positive continue right pad_right">
				<spring:theme code="checkout.pickup.continue.button" text="Continue" />
			</button>
		</form:form>
	</div>
	<a class="button" href="${nextStep}"><spring:theme
			code="checkout.multi.deliveryMethod.continue" text="Continue" /></a>
	<multi-checkout:checkoutOrderDetails cartData="${cartData}"
		showShipDeliveryEntries="false" showPickupDeliveryEntries="true"
		showTax="false" />
