				...
				<ycommerce:testId code="paymentDetailsForm">
					...
					<form:form id="silentOrderPostForm" name="silentOrderPostForm"
						...
						<c:if test="${not empty paymentInfos}">
							<button type="button" class="positive clear view-saved-payments"
								id="viewSavedPayments">
								<spring:theme
									code="checkout.multi.paymentMethod.viewSavedPayments"
									text="View Saved Payments" />
							</button>
						</c:if>
						...
						<div class="cardForm">
							...
							<fieldset id="startDate" class="cardDate" style="display: none;">
								...
								<formElement:formSelectBox idKey="StartYear"
									labelKey="payment.year" path="card_startYear" mandatory="true"
						...
						<div class="form-actions">
							...
							<button class="positive right submit_silentOrderPostForm"
								tabindex="20">
								...
								<div class="paymentEntry">
									...
									<form:form
										...
										<input type="hidden" name="paymentInfoId"
											value="${paymentInfo.id}" />
										<button type="submit"
											class="negative remove-payment-item right"
