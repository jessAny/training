	...
	<div class="span-24">
		...
		<div class="span-20 last">
			<cms:pageSlot position="Section2" var="feature" element="div"
				class="span-20 section2 cms_disp-img_slot">
				<cms:component component="${feature}" />
			</cms:pageSlot>
			<cms:pageSlot position="Section4" var="feature" element="div"
				class="span-20 last">
				<cms:component component="${feature}" element="div"
					class="span-6 section4 small_detail ${(elementPos%3 == 2) ? 'last' : ''}" />
			</cms:pageSlot>
			<cms:pageSlot position="Section5" var="feature" element="div"
				class="span-20 section5 cms_disp-img_slot last">
				<cms:component component="${feature}" />
			</cms:pageSlot>
		</div>
	</div>
