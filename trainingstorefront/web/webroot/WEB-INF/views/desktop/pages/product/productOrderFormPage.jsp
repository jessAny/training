...
<template:page pageTitle="${pageTitle}">
	...
	<jsp:body>
		...
		<c:url value="/cart/addGrid?CSRFToken=${CSRFToken}"
			var="addToCartGridUrl" />
		<spring:theme code="product.grid.future.tooltip.error"
			var="gridFutureTooltipErrorMessage" />
		<spring:theme code="product.grid.future.tooltip.delivery"
			var="gridFutureTooltipDeliveryMessage" />
		<spring:theme code="product.grid.future.tooltip.qty"
			var="gridFutureTooltipQtyMessage" />
		...
		<form:form name="AddToCartOrderForm" id="AddToCartOrderForm"
			class="add_to_cart_order_form" action="${addToCartGridUrl}"
			method="post" data-grid-confirm-message="${gridConfirmMessage}"
