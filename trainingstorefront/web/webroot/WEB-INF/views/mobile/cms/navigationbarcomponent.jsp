...
<c:if test="${empty component.navigationNode.children}">
	<c:set value="${component.styleClass} ${dropDownLayout}"
		var="bannerClasses" />
	<cms:component component="${component.link}" element="li"
		class="La ${bannerClasses}" evaluateRestriction="true" />
</c:if>
			...
			<ul data-role="listview" data-theme="f">
				<c:forEach items="${component.navigationNode.children}" var="child">
					<c:if test="${child.visible}">
						<div data-role="collapsiblelistview"
							class="navigationNodeParent ui-btn-up-f" data-theme="f">
							<h3 data-theme="d" class="ui-li-heading">
