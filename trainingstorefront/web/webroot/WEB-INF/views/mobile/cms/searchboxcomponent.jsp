	...
	<div class="accmob-search">
		<form name="search_form" method="get" action="${searchUrl}">
			...
			<ycommerce:testId code="header_search_input">
				...
				<input id="search" class="text accmob-mainSearch-input"
					type="search" name="text" value="" maxlength="100"
			...
			<div class="accmob-mainSearch-button">
				<ycommerce:testId code="header_search_button">
					...
					<input class="button" data-iconpos="notext"
						data-icon="custom-search" data-theme="d" type="submit"
						value="${searchText}" />
				</ycommerce:testId>
			</div>
		</form>
