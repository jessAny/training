...
<a title="Cart"
	class="ui-btn-right ui-btn ui-shadow ui-btn-corner-all ui-btn-icon-left ui-btn-up-b"
	id="top-nav-bar-cart" href="${basketUrl}"> <span
	class="ui-btn-inner ui-btn-corner-all"> <span
		class="ui-btn-text"> &nbsp;<spring:theme text="items"
				code="cart.count" arguments="${totalItems}" />
	</span> <span class="ui-icon ui-icon-cart ui-icon-shadow">&nbsp;</span>
</span>
</a>