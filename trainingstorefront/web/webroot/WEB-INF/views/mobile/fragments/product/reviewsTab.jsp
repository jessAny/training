...
<div id="read_reviews" data-theme="b">
	<ul class="review_actions" data-theme="b">
		<li><a href="#" id="write_review_action"> <c:choose>
		...
		<li>${fn:length(reviews)}&nbsp;<spring:theme
				code="review.number.of" />&nbsp;${reviewsTotal}&nbsp;<spring:theme
				code="review.number.reviews" />
		</li>
		<c:if test="${fn:length(reviews) ne reviewsTotal}">
			<li><a href="#" id="show_all_reviews_top_action"> <spring:theme
	...
	<c:if test="${not empty reviews}">
		<c:forEach items="${reviews}" var="review" varStatus="status">
			...
			<div class="review_detail" style="${reviewDetailStyle}">
				...
				<span class="stars large right" style="display: inherit;"> <span
		...
		<c:if test="${fn:length(reviews) ne reviewsTotal}">
			<a href="#" id="show_all_reviews_bottom_action"><spring:theme
					code="review.show.all" /></a>
		</c:if>
	</c:if>
</div>
