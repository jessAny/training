...
<div class="item_container_holder" data-content-theme="d" data-theme="e">
	...
	<div data-theme="d">
		<h3 class="summaryHeadline">
			<spring:theme code="text.account.order.summary"
		...
		<c:if
			...
			<div class="ui-grid-a productItemListHolder">
				<order:accountOrderDetailsItem order="${orderData}"
					consignment="${consignment}" inProgress="true" />
			</div>
		</c:if>
	</c:forEach>
	...
	<ul class="mFormList" data-theme="c" data-content-theme="c">
		<li>
			<div class="ui-grid-a right">
				...
				<a href="${ordersUrl}" data-role="button" data-theme="d"
					data-icon="arrow-l" class="ignoreIcon"> <spring:theme
						code="text.account.orderHistory" text="Order History" />
				</a>
			</div>
		</li>
	</ul>
