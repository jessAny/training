...
<%@ taglib prefix="mobiletemplate"
	tagdir="/WEB-INF/tags/mobile/template"%>
...
<form:form action="${updateProfileUrl}" method="post"
	commandName="updateProfileForm" data-ajax="false">
	<common:errors />
	<ul class="mFormList" data-theme="c" data-content-theme="c">
		<li><formElement:formSelectBox idKey="profile.title"
				labelKey="profile.title" path="titleCode" mandatory="true"
				skipBlank="false" skipBlankMessageKey="form.select.empty"
				items="${titleData}" /></li>
		<li><formElement:formInputBox idKey="profile.firstName"
				labelKey="profile.firstName" path="firstName" inputCSS="text"
				mandatory="true" /></li>
		<li><formElement:formInputBox idKey="profile.lastName"
