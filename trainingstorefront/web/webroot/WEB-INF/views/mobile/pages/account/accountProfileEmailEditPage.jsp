...
<div class="item_container">
	...
	<form:form action="${updateEmailUrl}" method="post"
		commandName="updateEmailForm" data-ajax="false">
		<common:errors />
		<ul id="updateEmailFormList" class="mFormList" data-inset="true">
			<li><formElement:formInputBox idKey="profile.email"
					labelKey="profile.email" path="email" inputCSS="text"
					mandatory="true" /></li>
			<li><formElement:formInputBox idKey="profile.checkEmail"
					labelKey="profile.checkEmail" path="chkEmail" inputCSS="text"
					mandatory="true" /></li>
			<li><formElement:formPasswordBox idKey="profile.pwd"
			...
			<li>
				<fieldset class="ui-grid-a doubleButton">
					<div class="ui-block-a">
						...
						<a href="${profileUrl}" data-role="button" data-theme="c"
							data-icon="delete" class="ignoreIcon"> <spring:theme
