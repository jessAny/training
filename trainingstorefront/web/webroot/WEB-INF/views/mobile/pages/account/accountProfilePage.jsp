...
<div class="item_container">
	...
	<fieldset>
		<ycommerce:testId code="profile_update">
			...
			<a href="${updateProfileUrl}" data-role="button" data-ajax="false"
				data-theme="d"> <spring:theme
					code="text.account.profile.updateProfile.mobile"
					text="Update Profile" />
			</a>
		</ycommerce:testId>
		<ycommerce:testId code="password_update">
			<c:url value="/my-account/update-password" var="updatePasswordUrl" />
			<a href="${updatePasswordUrl}" data-role="button" data-ajax="false"
				data-theme="d"> <spring:theme
					code="text.account.profile.changePassword.mobile"
					text="Change password" />
			</a>
		</ycommerce:testId>
		<ycommerce:testId code="edit_email">
			<c:url value="/my-account/update-email" var="updateEmailUrl" />
			<a href="${updateEmailUrl}" data-role="button" data-ajax="false"
				data-theme="d"> <spring:theme
					code="text.account.profile.updateEmail.mobile" text="Update email" />
			</a>
		</ycommerce:testId>
	</fieldset>
</div>