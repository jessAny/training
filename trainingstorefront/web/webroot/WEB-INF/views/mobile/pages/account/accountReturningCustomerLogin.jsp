...
<h6 class="descriptionHeadline">
	<spring:theme code="text.headline.register"
		text="Click here to register a new customer" />
</h6>

<div class="registerNewCustomerLinkHolder" data-theme="e"
	data-content-theme="e">
	<c:url value="/register" var="registerUrl" />
	<a href="${registerUrl}" data-role="button" data-theme="c"> <spring:theme
			code="register.new.customer" />
	</a>
</div>
