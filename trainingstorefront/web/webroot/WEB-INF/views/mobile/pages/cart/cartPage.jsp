...
<template:page pageTitle="${pageTitle}">
	<jsp:body>
		...
		<c:if test="${empty cartData.entries}">
			<cms:pageSlot position="EmptyCartTopContent" var="feature"
				element="div">
				<cms:component component="${feature}" />
			</cms:pageSlot>
			...
			<cms:pageSlot position="EmptyCartBottomContent" var="feature"
				element="div">
				<cms:component component="${feature}" />
			</cms:pageSlot>
		</c:if>
...
<c:forEach items="${cartData.entries}" var="entry">
	<storepickup:findPickupStores product="${entry.product}"
