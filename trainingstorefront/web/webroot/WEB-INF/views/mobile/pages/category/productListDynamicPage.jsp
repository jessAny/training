	...
	<jsp:body>
		...
		<cms:pageSlot position="Section1" var="feature" element="div"
			...
			<cms:component component="${feature}" element="div"
				class="span-24 section1 exhibit" />
		</cms:pageSlot>

		<cms:pageSlot position="Section2" var="feature" element="div"
			id="top-disp-img" class="home-disp-img">
			<cms:component component="${feature}" element="div"
				class="section2 exhibit" />
		</cms:pageSlot>

		<h6 class="descriptionHeadline">
			<spring:theme code="text.headline.refinements"
				text="Choose the relevance or add refinements" />
		</h6>

		<div class="productResultsList">
			<cms:pageSlot position="Section3" var="feature">
				<cms:component component="${feature}" element="div"
					class="span-24 section3 exhibit" />
			</cms:pageSlot>

			<c:if test="${empty searchPageData.results}">
				<ul id="categoryResultsList" data-role="listview" data-inset="true"
					data-theme="e" data-content-theme="e" class="mainNavigation">
					<category:categoryList pageData="${searchPageData}" />
				</ul>
			</c:if>
			<c:if test="${not empty searchPageData.results}">
				<div class="sortingBar item_container_holder">
					<nav:searchTermAndSortingBar pageData="${searchPageData}"
						top="true" showSearchTerm="false" />
				</div>
		...
		<cms:pageSlot position="Section4" var="feature">
			<cms:component component="${feature}" element="div"
				class="span-4 section4 exhibit last" />
		</cms:pageSlot>
	</jsp:body>
</template:page>
