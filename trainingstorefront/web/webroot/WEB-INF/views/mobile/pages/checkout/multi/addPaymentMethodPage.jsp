...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
	<jsp:body>
			...
			<form:form method="post" commandName="paymentDetailsForm"
				...
				<div data-theme="c">
					...
					<ul class="mFormList" data-theme="c" data-content-theme="c">
						...
						<li><formElement:formInputBox idKey="payment.nameOnCard"
								labelKey="payment.nameOnCard" path="nameOnCard" inputCSS="text"
								mandatory="true" tabindex="2" /></li>
						<li><formElement:formInputBox idKey="payment.cardNumber"
								labelKey="payment.cardNumber" path="cardNumber" inputCSS="text"
								mandatory="true" tabindex="3" /></li>
						<li>
							<label for="StartMonth"><spring:theme
									code="payment.startDate" /></label>
							<div class="ui-grid-a" data-theme="b">
								<div class="ui-block-a">
									<formElement:formSelectBox idKey="payment.month"
										labelKey="payment.month" path="startMonth" mandatory="true"
										skipBlank="false" skipBlankMessageKey="payment.month"
										items="${months}" tabindex="4" selectCSSClass="card_date" />
								</div>
								<div class="ui-grid-b">
									<formElement:formSelectBox idKey="payment.year"
										labelKey="payment.year" path="startYear" mandatory="true"
										skipBlank="false" skipBlankMessageKey="payment.year"
										items="${startYears}" tabindex="5" selectCSSClass="card_date" />
								</div>
							</div>
						</li>
						<li>
							...
							<div class="ui-grid-a" data-theme="b">
								<div class="ui-block-a">
									<formElement:formSelectBox idKey="payment.month"
										labelKey="payment.month" path="expiryMonth" mandatory="true"
										skipBlank="false" skipBlankMessageKey="payment.month"
										items="${months}" tabindex="6" />
								</div>
								<div class="ui-block-b">
									<formElement:formSelectBox idKey="payment.year"
										labelKey="payment.year" path="expiryYear" mandatory="true"
										skipBlank="false" skipBlankMessageKey="payment.year"
							...
							<div class="ui-grid-a" data-theme="b">
								<div class="ui-block-a" style="width: 50%">
									<formElement:formInputBox idKey="payment.issueNumber"
										labelKey="mobile.payment.issueNumber" path="issueNumber"
										inputCSS="text" mandatory="false" tabindex="4" />
								</div>
							</div>
						</li>
				...
				<div data-role="collapsible" data-collapsed="true"
					data-content-theme="c" data-theme="d" id="addBillingAddressForm"
					style="display: none">
					<h3>
						<spring:theme
					...
					<ul class="mFormList" data-theme="c" data-content-theme="c">
						...
						<li><formElement:formInputBox idKey="address.firstName"
								labelKey="address.firstName" path="billingAddress.firstName"
								inputCSS="text" mandatory="true" tabindex="11" /></li>
						<li><formElement:formInputBox idKey="address.surname"
								labelKey="address.surname" path="billingAddress.lastName"
								inputCSS="text" mandatory="true" tabindex="12" /></li>
						<li><formElement:formInputBox idKey="address.line1"
								labelKey="address.line1" path="billingAddress.line1"
								inputCSS="text" mandatory="true" tabindex="14" /></li>
						<li><formElement:formInputBox idKey="address.line2"
								labelKey="address.line2" path="billingAddress.line2"
								inputCSS="text" mandatory="false" tabindex="15" /></li>
						<li><formElement:formInputBox idKey="address.townCity"
								labelKey="address.townCity" path="billingAddress.townCity"
								inputCSS="text" mandatory="true" tabindex="16" /></li>
						<li><formElement:formInputBox idKey="address.postcode"
								labelKey="address.postcode" path="billingAddress.postcode"
								inputCSS="text" mandatory="true" tabindex="17" /></li>
						<li>
				...
				<ycommerce:testId code="checkout_useThesePaymentDetails_button">
					<div class="ui-grid-a doubleButton">
						<div class="ui-block-a">
							<a data-rel="back" class="form" type="button" data-theme="d"
								data-icon="delete">
						...
						<div class="ui-block-b">
							<button class="form left use_these_payment_details_button"
								tabindex="20" id="lastInTheForm" data-theme="c"
								data-icon="check">
		...
		<div class="checkoutOverviewItems">
			...
			<div>
				<checkout-cart:cartItemGroupsForPickUp cartData="${cartData}" />
			</div>
			<div>
				<cart:cartPromotions cartData="${cartData}" />
			</div>
			<div>
				<cart:cartTotals cartData="${cartData}" showTaxEstimate="false"
					showTax="true" />
			</div>
		</div>
	</jsp:body>
