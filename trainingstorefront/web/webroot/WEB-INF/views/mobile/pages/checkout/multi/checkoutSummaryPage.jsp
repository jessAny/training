...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
	...
	<jsp:body>
		...
		<div data-theme="d" data-role="content">
			<div data-theme="b">
				<multi-checkout:summaryFlow deliveryMode="${deliveryMode}"
					paymentInfo="${paymentInfo}"
					requestSecurityCode="${requestSecurityCode}" cartData="${cartData}" />
			</div>
		</div>
		<div data-theme="d">
			<form:form action="${placeOrderUrl}" id="placeOrderForm1"
				...
				<common:errors />
				<form:input type="hidden" name="securityCode"
					class="securityCodeClass" maxlength="5" path="securityCode" />
				<h6 class="descriptionHeadline">
					<spring:theme code="text.headline.terms"
				...
				<ul data-theme="c" data-content-theme="c"
					class="checkoutSummarySubmit">
					<li>
						<button type="submit" data-icon="arrow-r" data-theme="b"
							data-iconpos="right"
				...
				<div class="checkoutOverviewItems">
					<div data-theme="b">
						...
						<checkout-cart:cartItemGroupsForPickUp cartData="${cartData}"
							showAllItems="${showAllItems}" summary="true" />
					</div>
					<div data-theme="b">
				...
				<ul data-theme="c" data-content-theme="c"
					...
					<li>
						<button type="submit" data-icon="arrow-r" data-theme="b"
							data-iconpos="right"
							class="positive right pad_right place-order placeOrderWithSecurityCode show_processing_message">
							<spring:theme code="checkout.summary.placeOrder" />
						</button>
					</li>
				</ul>
