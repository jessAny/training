	...
	<jsp:body>
		...
		<div class="item_container_holder" data-theme="b" data-role="content">
			<div data-theme="b">
				...
				<h3 class="infotext">
					<spring:theme
						code="checkout.multi.pickupInStore.confirm.and.continue" />
				</h3>
			</div>
		</div>
		...
		<div>
			<checkout:pickupConsolidationOptions cartData="${cartData}"
				pickupConsolidationOptions="${pickupConsolidationOptions}" />
		</div>
		<div>
			<a data-role="button" data-theme="b" href="${choosePaymentMethodUrl}"
