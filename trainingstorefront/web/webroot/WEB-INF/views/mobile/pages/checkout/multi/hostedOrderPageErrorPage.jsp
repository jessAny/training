					...
					<div id="errorDetailsSection">
						<span class=" form_field_error">
							<p id="errorDetailsText">
								<spring:theme
									code="checkout.multi.hostedOrderPageError.${decision}.${reasonCode}" />
							</p>
						</span> <a id="continueButton" href="${continueUrl}"
							class="positive right" data-role="button" role="button"
							data-theme="b"> <spring:theme
								code="checkout.multi.hostedOrderPageError.continue" />
						</a>
					</div>
				</div>
			</div>
