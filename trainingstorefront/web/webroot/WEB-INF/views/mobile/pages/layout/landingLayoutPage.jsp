...
<template:page pageTitle="${pageTitle}">
	...
	<div id="top-disp-img" class="home-disp-img">
		<h6 class="descriptionHeadline">
			<spring:theme code="text.headline.homebanner" text="Top Banner" />
		</h6>
		<cms:pageSlot position="Section1" var="feature" element="div"
			id="categoryImage-Disp">
	...
	<cms:pageSlot position="Section2" var="feature" element="div"
		class="home-disp-img">
		<cms:component component="${feature}" element="div"
			class="span-24 section2 cms_disp-img_slot" />
	</cms:pageSlot>
	...
	<div class="mainNavigation" data-role="content" data-theme="e"
		data-content-theme="e">
		<h6 class="descriptionHeadline">
			<spring:theme code="text.headline.productcategories"
				text="Product categories" />
		</h6>
		<cms:pageSlot position="NavigationBar" var="feature" element="ul"
			data-role="listview" data-inset="true" data-theme="e">
	...
	<div id="bottom-disp-img" class="home-disp-img">
		<h6 class="descriptionHeadline">
			<spring:theme code="text.headline.bottombanner" text="Bottom Banner" />
		</h6>
