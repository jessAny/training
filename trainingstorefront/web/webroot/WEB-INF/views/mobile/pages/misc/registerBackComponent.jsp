...
<div
	class="registerNewCustomerLinkHolder registerNewCustomerLinkHolderBack"
	...
	<a href="${loginUrl}" data-role="link" data-theme="d"> &laquo; <spring:theme
			code="register.back.login" />
	</a>
</div>
