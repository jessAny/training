...
<template:page pageTitle="${pageTitle}">
	<div class="item_container_holder">
		...
		<h3>
			<spring:theme code="review.write.title.product"
		...
		<div class="item_container writeReview">
			<div class="ui-grid-a reviewDetails">
				<div class="ui-block-a">
					<a href="${productUrl}" data-transition="slide"> <product:productCartImage
			...
			<ul class="mFormList" data-inset="true" data-theme="d">
				...
				<form:form method="post" action="${reviewFormAction}"
					commandName="reviewForm">
					<common:errors />
					<li><formElement:formInputBox idKey="review.headline"
							labelKey="review.headline" path="headline" inputCSS="text"
							mandatory="true" /></li>
					<li><formElement:formTextArea idKey="review.comment"
							labelKey="review.comment" path="comment" areaCSS="textarea"
							mandatory="true" /></li>
					<spring:bind path="rating">
						<li>
							<div class="ui-field-contain ui-body ui-br">
								<label for="rating" class="ui-input-text"> <spring:theme
										code="review.rating" />
								</label>
					...
					<li><formElement:formInputBox idKey="review.alias"
							labelKey="review.alias" path="alias" inputCSS="text" tabindex="8" /></li>
					<li>
						<button class="form" data-theme="c"
