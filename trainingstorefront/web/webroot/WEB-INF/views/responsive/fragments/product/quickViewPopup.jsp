...
<div class="quick-view-popup">
	...
	<div class="addtocart-component">
		...
		<form:form method="post" class="add_to_cart_form"
			action="${addToCartUrl}">
			<input type="hidden" name="productCodePost" value="${product.code}" />

			<c:if
				test="${empty quickViewShowAddToCart ? true : quickViewShowAddToCart}">
				...
				<div class="qty-selector input-group js-qty-selector">
					<span class="input-group-btn">
						...
						data-max="${product.stock.stockLevel}" data-min="1" id="qty"
						name="qty" /> <span class="input-group-btn">
		...
		<c:if
			test="${empty quickViewShowAddToCart ? true : quickViewShowAddToCart and product.availableForPickup}">
			<c:set var="actionUrl"
				value="${fn:replace(url,'{productCode}', product.code)}"
				scope="request" />
