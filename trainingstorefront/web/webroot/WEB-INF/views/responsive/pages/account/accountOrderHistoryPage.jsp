						...
						<tr class="responsive-table-item">
							<ycommerce:testId code="orderHistoryItem_orderDetails_link">
								...
								<td class="responsive-table-cell"><a
									href="${orderDetailsUrl}${order.code}"
									class="responsive-table-link"> ${order.code} </a></td>
								<td class="hidden-sm hidden-md hidden-lg"><spring:theme
										code="text.account.orderHistory.orderStatus" /></td>
								<td class="status"><spring:theme
								...
								<td class="responsive-table-cell"><fmt:formatDate
										...
										type="both" /></td>
								<td class="hidden-sm hidden-md hidden-lg"><spring:theme
										code="text.account.orderHistory.total" /></td>
								<td class="responsive-table-cell responsive-table-cell-bold">
									${order.total.formattedValue}</td>
							</ycommerce:testId>
						</tr>
					</c:forEach>
				</table>
