				...
				<c:forEach items="${paymentInfoData}" var="paymentInfo">
					...
					<div style="display: none">
						<div id="popup_confirm_payment_removal_${paymentInfo.id}"
							...
							<div class="address">
								<strong> ${fn:escapeXml(paymentInfo.accountHolderName)}
								</strong> <br>${fn:escapeXml(paymentInfo.cardTypeData.name)} <br>${fn:escapeXml(paymentInfo.cardNumber)}
								<br>
								...
								<div class="modal-actions">
									...
									<div class="col-xs-12 col-sm-6 col-sm-pull-6">
										<a
											...
											data-payment-id="${paymentInfo.id}"> <spring:theme
