...
<div class="row">
	...
	<div class="col-md-6 col-lg-4">
		<div class="express-checkout">
			...
			<sec:authorize access="isFullyAuthenticated()">
				<c:if test="${expressCheckoutAllowed}">
					<div class="checkbox">
						<label> <c:url value="/checkout/multi/express"
								var="expressCheckoutUrl" scope="session" /> <input
							type="checkbox" class="express-checkout-checkbox"
							data-express-checkout-url="${expressCheckoutUrl}"> <spring:theme
		...
		<div class="row cart-actions">
			<div class="col-sm-6">
				<button class="btn btn-default btn-block continueShoppingButton"
			...
			<div class="col-sm-6">
				<button
					class="btn btn-primary btn-block checkoutButton continueCheckout"
	...
	<div class="row cart-actions">
		<div class="col-xs-12 col-sm-6 col-md-3 col-lg-2">
			<input type="hidden" name="flow" id="flow" /> <input type="hidden"
				...
				class="doFlowSelectedChange form-control">
				...
				<c:if test="${!isOmsEnabled}">
					<option value="default"><spring:theme
							code="checkout.checkout.multi.pci-ws" /></option>
