	...
	<jsp:body>
        ...
        <div class="product-details">
            <ycommerce:testId
                ...
                <div class="name product-details-toggle">${product.name} <span
						class="sku">ID</span><span class="code">${product.code}</span><span
        ...
        <div class="add-to-cart-order-form-wrap">
            ...
            <form:form name="AddToCartOrderForm" id="AddToCartOrderForm"
				class="add_to_cart_order_form scrollContent visible"
            ...
            <div class="order-form-scroll right hidden-xs">
				<span class="glyphicon glyphicon-chevron-right"></span>
			</div>
            <div class="order-form-scroll left hidden-xs">
				<span class="glyphicon glyphicon-chevron-left"></span>
			</div>
            <div class="order-form-scroll up hidden-xs">
				<span class="glyphicon glyphicon-chevron-up"></span>
			</div>
            <div class="order-form-scroll down hidden-xs">
